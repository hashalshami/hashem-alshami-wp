...
<h1 class="wp-block-heading has-text-align-left has-nv-text-dark-bg-color has-text-color">أنشئ موقع الويب الفريد الخاص بك وطوره اليوم</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":17}},"textColor":"nv-text-dark-bg"} -->
<p class="has-text-align-left has-nv-text-dark-bg-color has-text-color" style="font-size:17px">العمل برمجيًا ولكن الثمار المعلقة منخفضة جدًا، لذا فإن التلقيح المتبادل للاقتصاد الجديد. المزامنة السريعة للاقتصاد الجديد إلى الأمام وإلى الأعلى.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-primary"><a class="wp-block-button__link has-text-color has-background has-link-color wp-element-button" href="' . esc_url( home_url( '/about/' ) ) . '" style="color:#0a2279;background-color:#ffffff">إبدا الان </a></div>
<!-- /wp:button -->
...
<div class="wp-block-button is-style-secondary"><a class="wp-block-button__link has-nv-text-dark-bg-color has-text-color has-link-color wp-element-button" href="' . esc_url( home_url( '/portofolio/' ) ) . '"> تواصل معنا</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
